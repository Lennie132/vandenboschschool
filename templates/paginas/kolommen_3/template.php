    ...
    <div class="row">
      <div class="col-md-4">
        <?php
          ...
          echo lcms::Template()->getSectieContent($DATA['page'], 'kolom_1');
        ?>
      </div>
      <div class="col-md-4">
        <?php
          /** Hier wordt het rechter deel ingelezen * */
          echo lcms::Template()->getSectieContent($DATA['page'], 'kolom_2');
        ?>
      </div>
      <div class="col-md-4">
        <?php
          /** Hier wordt het rechter deel ingelezen * */
          echo lcms::Template()->getSectieContent($DATA['page'], 'kolom_3');
        ?>
      </div>
    </div>
  </div>
