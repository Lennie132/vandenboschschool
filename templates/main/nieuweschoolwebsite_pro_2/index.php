...
<html class="no-js" lang="<?= Taal::get_current(); ?>">
    <head>
        ...
        lcms_client_script::add_main_js('js/jquery-tooltip.js', true);

        /** custom LESS inladen * */
        //lcms_client_script::add_less('js/style.less', true);
        lcms_client_script::add_less('maatwerk/bestanden_module/css/style.less', true);

        /** custom JS inladen * */
        //lcms_client_script::add_js('client/template/custom/js/plugins.js', true);
        lcms_client_script::add_js('maatwerk/bestanden_module/js/plugins.js', true);
        lcms_client_script::add_js('maatwerk/bestanden_module/js/main.js', true);
