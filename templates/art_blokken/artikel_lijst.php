...
if (!empty($art_arr)) {
    ?>
    <div class="">
        <?php foreach ($art_arr as $key => $artikel) {
          ...
          switch ($artikel['soort']) {
                    ...
                    // Afbeelding en tekst
                        ...
                        switch ($artikel['grootte_blok']) {
                          case '1':
                            $width = 'col-lg-2 col-md-2 col-sm-6 col-xs-12';
                            $height = 'block--small';
                            break;
                            case '2':
                              $col = 'col-lg-2 col-md-2 col-sm-6 col-xs-12';
                              $height = 'block--middle';
                              break;
                              case '3':
                  ...
                  case 2:
                    ...
                    <div class="block grid-item <?= $col; ?> ">
                        ...
                        <div class="block__wrapper block--style-2 <?= $height; ?> <?= $colour; ?>">
